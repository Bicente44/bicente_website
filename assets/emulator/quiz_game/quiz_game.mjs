...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'quiz_game.data';
      var REMOTE_PACKAGE_BASE = 'quiz_game.data';
...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_quiz_game.data');

      };
      Module['addRunDependency']('datafile_quiz_game.data');
    ...
    loadPackage({"files": [{"filename": "/quiz_game.db", "start": 0, "end": 24576}], "remote_package_size": 24576});
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'quiz_game.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('quiz_game.wasm', import.meta.url).href;
}
...
var _sigaction = createExportWrapper('sigaction');
